...
.. |SCIPP_VERSION| replace:: {ess.__version__}
"""  # noqa: E501
...
latex_documents = [
    (master_doc, 'ess.tex', u'ess Documentation', u'Scipp contributors', 'manual'),
]
...
man_pages = [(master_doc, 'ess', u'ess Documentation', [author], 1)]
