...
- Delete unnecessary files:
  `tox.ini`, `requirements/`, `.github/`, `.pre-commit-config.yaml`, `.copier-answers.yml`, `.copier-answers.ess.yml`, `CODE_OF_CONDUCT.md`, `CONTRIBUTING.md`, `LICENSE`, `MANIFEST.in`, `.gitignore`, `.python-version`.
