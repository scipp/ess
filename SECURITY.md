...
If you believe you have found a security vulnerability in an ess package, please

- ✅ report it to us by creating a [security advisory](https://github.com/scipp/ess/security/advisories/new).
...
We use GitHub [security advisories](https://github.com/scipp/ess/security/advisories) to disclose fixed vulnerabilities.
