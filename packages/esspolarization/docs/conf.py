...
sciline_domain_types_prefix = 'ess.polarization'
...
try:
    release = get_version("esspolarization")
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/scipp/esspolarization",
            "icon": "fa-brands fa-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/esspolarization/",
            "icon": "fa-brands fa-python",
            "type": "fontawesome",
        },
        {
            "name": "Conda",
            "url": "https://anaconda.org/conda-forge/esspolarization",
...
htmlhelp_basename = 'esspolarizationdoc'
